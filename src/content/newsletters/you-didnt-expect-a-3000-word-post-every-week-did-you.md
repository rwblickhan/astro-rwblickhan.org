...
The rest of this newsletter is just a bunch of little updates. What, you didn’t expect a [3,000-word post on the ethics of using Claude Code](/ai/) _every_ week, did you?

---

I cleaned up the [front page of my website](/), partly inspired by a [BlueSky post from Craig Mod](https://bsky.app/profile/craigmod.com/post/3lpncsamfhs2k):
...
If you check the [sitemap](/map/), you’ll now see that there’s only three major categories: evergreen (for “evergreen” lists and notes that I keep up to date), creative writing (for short stories and poetry), and newsletters (for everything else, including essays I didn’t originally send as newsletters).[^note1]
...
You may recall [my breathless excitement for jujutsu version control](/newsletters/really-truly-breathless-with-excitement/) a few weeks ago. But I _completely forgot_ to mention how I actually learned jujutsu!
