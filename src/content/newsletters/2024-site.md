...
Last time I discussed [how this site is built](/technical/2022-site/) was two and a half years (!) ago. The site has changed quite a bit since then. Here’s how it’s built today.
...
As mentioned, that may sound a little complicated, but let’s follow the example of my [pattern language](/misc/pattern-language/) page.
...
I also have a few one-off pages, like the [main page](https://rwblickhan.org), search, [“Map”](/map/)(which links to all the index pages), a [gallery](/gallery/) of photos I’ve taken, and an internal [style guide](/styleguide/) to test CSS changes.
