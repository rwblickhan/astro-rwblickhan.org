...
<Image src={andor} alt="Poster for *Andor* season 1" class={'float'} />
...
<Image src={gentlemen} alt="Poster for *Gentlemen Prefer Blondes*" class={'float'} />
...
<Image src={megalopolis} alt="Poster for *Megalopolis*" class={'float'} />
...
<Image src={master} alt="Poster for *The Master*" class={'float'} />
...
<Image src={francesha} alt="Poster for *Frances Ha*" class={'float'} />
...
<Image src={lookback} alt="Poster for *Look Back*" class={'float'} />
...
<Image src={sacrifice} alt="Poster for *The Sacrifice*" class={'float'} />
...
<Image src={getout} alt="Poster for *Get Out*" class={'float'} />
...
<Image src={zoneofinterest} alt="Poster for *The Zone of Interest*" class={'float'} />
...
<Image src={rosemarys} alt="Poster for *Rosemary's Baby*" class={'float'} />
...
<Image src={bartonfink} alt="Poster for *Barton Fink*" class={'float'} />
...
<Image src={tar} alt="Poster for *Tár*" class={'float'} />
...
<Image src={ytumamatambien} alt="Poster for *Y Tu Mamá También*" class={'float'} />
