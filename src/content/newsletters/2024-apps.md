...
Let’s check in on what my default apps are these days. I [enjoyed this exercise](/newsletters/rwblog-tools-for-2022/) two years ago, so let’s do it again!
...
[**Things 3**](https://culturedcode.com/things/) remains possibly the best software I’ve ever used, [just as it was two years ago](/newsletters/rwblog-tools-for-2022/#task-management). I continue to abide by “if it’s not in Things, it doesn’t get done.”
...
For “longform” notes and [goal tracking](/essays/yearly-goals/), I still swear by [**Obsidian**](https://obsidian.md), with my notes sorted by a set of a hundred or so tags. [As described last time](/newsletters/rwblog-tools-for-2022/#notes), I also have a macOS Shortcut to quickly grab links from Safari and plop them in my Obsidian vault.
...
For fiction, I’m [still using](/newsletters/rwblog-tools-for-2022/#writing) [**Ulysses**](https://ulysses.app), especially for its fine-grained word-count-goal settings.
...
I’m [still using](/newsletters/rwblog-tools-for-2022/#rss) [**NetNewsWire**](https://netnewswire.com) and have no complaints.

## Read-It-Later

I’m [still using](/newsletters/rwblog-tools-for-2022/#link-savingread-it-later) [**GoodLinks**](https://goodlinks.app) and have no complaints.

## Bookmarking

Earlier this year, I [built my own bookmarks site](/technical/bookmarks/) with full-text search, but it was too much of a hassle to maintain. Instead, I set up [**Raindrop.io**](https://raindrop.io), which supports full-text search and PDF uploads on the pro plan. It works like a charm if I need to search for an old article about, say, [geometric algebra](https://alexkritchevsky.com/2024/02/28/geometric-algebra.html).
...
I’m [still using](/newsletters/rwblog-tools-for-2022/#podcasts) [**Overcast**](https://overcast.fm), although now I have the complaint that its performance is suspiciously sluggish.

## Web Browser

I still use **Safari**, since [Safari is the lightest browser](/newsletters/once-the-canadians-in-the-audience-recover-from-their-shock/#safari-is-the-lightest-browser). That said, when I do need a Chromium-based browser (e.g. for React Dev Tools), I don’t mind using [**Arc Browser**](https://arc.net).
